...
def trading_strategy(df):
    ...
    df = detector.detect_main_wave(strict=False)
    ...
    if df["is_main_wave"].iloc[-1] and portfolio["position"] == "FLAT":
        signal = "BUY"
        portfolio["pending_signal"] = "BUY"
    elif not df["is_main_wave"].iloc[-1] and portfolio["position"] == "LONG":
        signal = "SELL"
        portfolio["pending_signal"] = "SELL"
